...
VERSION=703.00
TDB=TDB_full_${VERSION}_2016_10_17
GIT=https://raw.githubusercontent.com/TrinityCore/TrinityCore/master
...
create-database:
	...
	wget https://github.com/TrinityCore/TrinityCore/releases/download/TDB${VERSION}/${TDB}.7z
	p7zip -d ${TDB}.7z
...
create-config:
	...
	sed 's/Appender.Console.*=.*/Appender.Console=1,0,0/g' | \
